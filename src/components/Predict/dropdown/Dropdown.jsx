...
const Dropdown = ({options, coinSymbol, className = "", onChange, setSelectedPredictPeriod, setSelectedCoinSymbol,setSelectedCoinPair, optionKey, optionValue, isObject}) => {
